        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 flex items-center justify-center">
            <div className="text-center px-8">
                <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-200 to-purple-200 animate-pulse">
                    Welcome To Quize Hive
                </h1>
                <p className="text-xl md:text-2xl text-blue-100 mb-8 font-medium">
                    Welcome to Quize Hive, your ultimate destination for quizzes and learning!
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <NavLink to="/questionset/list"><button className="px-8 py-4 bg-white/20 backdrop-blur-md border border-white/30 rounded-full text-white font-semibold hover:bg-white/30 transition-all duration-300 hover:scale-105">
                        Get Started
                    </button></NavLink>
                    <NavLink to="/profile"><button className="px-8 py-4 bg-gradient-to-r from-pink-500 to-violet-600 rounded-full text-white font-semibold hover:from-pink-600 hover:to-violet-700 transition-all duration-300 hover:scale-105 shadow-lg">
                        View Profile
                    </button></NavLink>
                </div>
